...
@section('content')
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-body">
          <h1 class="card-description" style="text-align: center;">Edit Sale<a href="{{route('backend.sale.create')}}" class="btn btn-info" style="float: right; color: white"><i class="mdi mdi-library-plus"></i> Create Sale</a><a href="{{route('backend.sale.index')}}" class="btn btn-primary" style="float: right; color: white"><i class="mdi mdi mdi-view-list"></i> List Sale</a></h1>
