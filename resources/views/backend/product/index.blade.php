              ...
              <div class="row">
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              <div class="box-body">
                                  <h1 class="card-description" style="text-align: center;">List Product<a href="{{route('backend.product.create')}}" class="btn btn-info" style="float: right; color: white"><i class="mdi mdi-library-plus"></i> Create Product</a></h1>
