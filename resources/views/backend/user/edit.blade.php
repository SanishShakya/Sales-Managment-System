...
@section('content')
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-body">
          <h1 class="card-description" style="text-align: center;">Edit User<a href="{{route('backend.user.create')}}" class="btn btn-info" style="float: right; color: white"><i class="mdi mdi-library-plus"></i> Create User</a><a href="{{route('backend.user.index')}}" class="btn btn-primary" style="float: right; color: white"><i class="mdi mdi mdi-view-list"></i> List Product</a></h1>
